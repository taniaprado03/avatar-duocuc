const TRAMITES = [
    {
        ...
        descripcion: 'Genera un certificado que acredita tu matrícula vigente en DUOC UC.',
        resultado: '✅ Certificado de Alumno Regular generado exitosamente.\n\n📄 Documento: CERT-2026-AR-00847\nEstudiante: Usuario Simulado\nCarrera: Ingeniería en Informática\nSede: San Bernardo\nVigencia: 25/02/2026 — 25/08/2026\n\nEl certificado ha sido enviado a tu correo institucional y está disponible para descarga en el tótem.'
    },
    {
        id: 2,
    ...
    },
    {
        ...
        descripcion: 'Consulta el estado de tus pagos, becas y deudas.',
        resultado: '💰 Situación Financiera — 2026\n\n👤 Usuario Simulado\n\n📋 Resumen:\n  Arancel Anual: $3.200.000\n  Beca Excelencia Académica: -$1.600.000 (50%)\n  Monto a Pagar: $1.600.000\n\n✅ Cuotas Pagadas: 2 de 10\n💳 Próximo Vencimiento: 05/03/2026 — $160.000\n\n📌 Estado: Al día — Sin deuda pendiente\n\n🎓 Beca vigente hasta diciembre 2026'
    }
];
